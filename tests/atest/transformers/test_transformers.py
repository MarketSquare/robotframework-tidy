...
class TestOrderSettingsSection:
    ...
    def test_missing_group(self):
        run_tidy_and_compare(self.TRANSFORMER_NAME, sources=['missing_group.robot'])

    def test_just_comment(self):
        run_tidy_and_compare(self.TRANSFORMER_NAME, sources=['just_comment.robot'])

    def test_last_section(self):
        run_tidy_and_compare(self.TRANSFORMER_NAME, sources=['last_section.robot'])
