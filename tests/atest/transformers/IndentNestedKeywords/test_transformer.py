...
class TestIndentNestedKeywords(TransformerAcceptanceTest):
    ...
    def test_split_and_indent(self):
        self.compare(
            source="run_keyword.robot", expected="split_and_indent.robot", config=":indent_and=split_and_indent"
        )
    ...
    def test_indent_and_continuation_indent(self):
        self.compare(
            ...
            config=":indent_and=split_and_indent --spacecount 2 --continuation-indent 4",
        )
